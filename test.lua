...
local DEFAULT_URL     = "wss://d4a0cfffa3ca.ngrok-free.app"
...
local chatList = nil -- ใช้เก็บข้อความ chat
...
local function createChatUI()
    ...
    chatFrame.Position        = UDim2.new(0.3,0,0.25,0)
    ...
    chatOutputFrame.Size             = UDim2.new(1,-20,0.65,0)
    chatOutputFrame.Position         = UDim2.new(0,10,0.12,0)
    ...
    chatOutputFrame.ScrollBarThickness = 6
    ...
    chatInput.Position        = UDim2.new(0,10,0.78,0)
    ...
    chatBtn.Position      = UDim2.new(0.7,0,0.78,0)
...
local function addChatMessage(text)
    ...
    -- อัปเดต CanvasSize ให้ scroll ได้
    chatOutputFrame.CanvasSize = UDim2.new(0,0,0,chatList.AbsoluteContentSize.Y)
    chatOutputFrame.CanvasPosition = Vector2.new(0, chatOutputFrame.CanvasSize.Y.Offset) -- scroll ลงล่าง
end
